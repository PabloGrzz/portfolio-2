  ...
  return (
    <header className="absolute w-full z-50 transition-all duration-300">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
            ...
            className='hidden md:inline-block ml-4 px-4 py-2 rounded-xl bg-gradient-to-r from-gray-400 to-gray-100 text-violet-700 font-bold hover:from-violet-700 hover:to-purple-700 hover:text-white
                    ...
                    >
                        <div className='flex justify-between items-center mb-4'>
                            ...
                            <button onClick={closeContactForm}>
                                <FiX className='w-5 h-5 test-gray-300 font-extrabold'/>
                            </button>
                        </div>
                        ...
                        <form className='space-y-4'>
                            ...
                            <div>
                                ...
                                <textarea rows="4" id='message' placeholder='¿Como podemos ayudarte?' 
                                className='w-full px-4 py-2 border border-gray-600 rounded-lg focus:ring-2
                                focus:ring-violet-500 focus:border-violet-500 bg-gray-700' />
